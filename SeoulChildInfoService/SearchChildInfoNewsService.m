...
#import "SearchChildInfoNewsServiceContent.h"


@implementation SearchChildInfoNewsService
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	subview = [[UIView alloc] initWithFrame:CGRectMake(30,30,250,350)];
	 ...
	 SearchChildInfoNewsServiceContent *searchChildInfoNewsServiceContent= [[SearchChildInfoNewsServiceContent alloc] init];
	 [searchChildInfoNewsServiceContent passParaToXML:curID];
	 
	 NSLog(@"테이블 클릭 실행"); 
	 
	 CGRect newFrame = searchChildInfoNewsServiceContent.view.frame;
	 newFrame.size.height = newFrame.size.height -1;
	 searchChildInfoNewsServiceContent.view.frame = newFrame;
	 subview=searchChildInfoNewsServiceContent.view;	
	 [self.view addSubview:subview];
	*/
	
	SearchChildInfoNewsServiceContent *searchChildInfoNewsServiceContent =
	[[SearchChildInfoNewsServiceContent alloc] initWithNibName:@"SearchChildInfoNewsServiceContent" bundle:nil];
	[searchChildInfoNewsServiceContent passParaToXML:curID];
	[self.navigationController  pushViewController:searchChildInfoNewsServiceContent animated:YES];
	[searchChildInfoNewsServiceContent release];
...

{
	...
	NSString *soapMessage = [NSString stringWithFormat:
							 ...
							 "<ChildInfoType>02</ChildInfoType>\n"
							 "<viewNotice>N</viewNotice>\n"
							 "<PageNum>%@</PageNum>\n"
